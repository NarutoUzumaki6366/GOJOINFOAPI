...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "IND":
        return "uid=4277225734&password=ZAXYGOJO-L1NTWUZIM-CODERRR"
    elif r == "BD":
        return "uid=4231522255&password=86CEA4D405969AAFB8DFAC77EE29982A4C8657BC9FBBA499151697756FF6D334"
